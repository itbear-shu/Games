...
public class Bg {
    ...
    void paintSelf(Graphics g) {
        ...
        switch (GameWin.state) {
            case 0:
                drawWord(g, 80, Color.green, "准备开始", 300, 400);
                break;
            case 1:
                g.drawImage(peo, 400, 50, null);
                drawWord(g, 30, Color.black, "积分:" + count, 30, 150);
                //药水组件
                g.drawImage(water, 200, 125, null);
                drawWord(g, 30, Color.black, "*" + waterNum, 270, 155);
                //关卡数
                drawWord(g, 60, Color.red, "第" + level + "关", 700, 120);
                //目标积分
                drawWord(g, 30, Color.black, "目标" + goal, 30, 110);
                //时间组件
                endTime = System.currentTimeMillis();
                long tim = 60 - (endTime - startTime) / 1000;
                drawWord(g, 30, Color.black, "时间:" + (tim > 0 ? tim : 0), 730, 180);
                break;
            case 2:
                ...
                break;
            case 3:
                drawWord(g, 80, Color.cyan, "失败", 300, 400);
                drawWord(g, 80, Color.cyan, "积分:" + count, 300, 450);
                break;
            case 4:
                drawWord(g, 80, Color.red, "成功", 300, 400);
                drawWord(g, 80, Color.red, "积分:" + count, 300, 450);
                break;
            default:
        }
    }
